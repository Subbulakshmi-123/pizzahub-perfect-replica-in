...
import { ShoppingCart, Menu, X, MapPin, Phone, User, Pizza } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3">
            <div className="bg-blue-900 text-white p-3 rounded-lg flex items-center space-x-2">
              <Pizza className="text-red-500" size={28} />
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              ...
              CART
              {cartItemsCount > 0 && (
                <span className="absolute -top-2 -right-2 bg-yellow-400 text-black text-xs rounded-full px-2 py-1 min-w-[24px] h-6 flex items-center justify-center font-bold animate-pulse">
                  {cartItemsCount}
                </span>
              )}
            </Button>
        ...
        {isMobileMenuOpen && (
          <nav className="md:hidden mt-4 py-4 border-t">
            <div className="flex flex-col space-y-4">
              <a href="#menu" className="text-gray-800 hover:text-blue-900 font-semibold text-lg" onClick={() => setIsMobileMenuOpen(false)}>
                MENU
              </a>
              <a href="#deals" className="text-gray-800 hover:text-blue-900 font-semibold text-lg" onClick={() => setIsMobileMenuOpen(false)}>
                DEALS
              </a>
              <a href="#stores" className="text-gray-800 hover:text-blue-900 font-semibold text-lg" onClick={() => setIsMobileMenuOpen(false)}>
                STORES
              </a>
              <a href="#about" className="text-gray-800 hover:text-blue-900 font-semibold text-lg" onClick={() => setIsMobileMenuOpen(false)}>
                ABOUT US
              </a>
            </div>
          </nav>
